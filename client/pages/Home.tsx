      ...
      <div className="relative z-10">
        <section className="px-4 sm:px-6 lg:px-8 py-20 max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-2xl text-gray-600 mb-8 max-w-2xl mx-auto">
              Decouvrez notre collection exclusive de T-shirts et Gants premium
            </p>
            <Link to="/products">
        ...
        <section className="px-4 sm:px-6 lg:px-8 py-20 max-w-7xl mx-auto">
          <div className="mb-16 text-center">
            ...
            <p className="text-lg text-gray-600">Explorez les differentes sections de notre site</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            <Link to="/products" className="group">
              <div className="bg-white rounded-2xl shadow-lg p-8 hover:shadow-2xl transition-all border-2 border-pink-100 hover:border-primary">
                ...
                <p className="text-gray-600 text-center mb-6">
                  Parcourez nos collections de T-shirts et Gants premium avec tous les details produits.
                </p>
            ...
            <div className="group">
              <div className="bg-white rounded-2xl shadow-lg p-8 hover:shadow-2xl transition-all border-2 border-pink-100 hover:border-primary">
                ...
                <h3 className="text-2xl font-bold text-gray-900 text-center mb-3">A propos</h3>
                <p className="text-gray-600 text-center mb-6">
                  Decouvrez l histoire de Iron divas et notre engagement envers la qualite et la durabilite.
                </p>
                <div className="text-center">
            ...
            <a href="https://wa.me/21621476163" target="_blank" rel="noopener noreferrer" className="group">
              <div className="bg-white rounded-2xl shadow-lg p-8 hover:shadow-2xl transition-all border-2 border-pink-100 hover:border-green-400">
                <div className="flex justify-center mb-6">
                ...
                <div className="text-center">
                  <span className="inline-block px-6 py-2 bg-green-50 text-green-600 font-semibold rounded-full">
                    Contacter ?
                  </span>
                </div>
              </div>
        ...
        <section className="px-4 sm:px-6 lg:px-8 py-20 max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white rounded-2xl p-8 shadow-lg border-2 border-pink-100">
              <h3 className="text-xl font-bold text-gray-900 mb-3">? Qualite Premium</h3>
              <p className="text-gray-600">
                Tous nos produits sont fabriques avec les meilleurs materiaux pour garantir votre confort.
              </p>
            </div>
            <div className="bg-white rounded-2xl p-8 shadow-lg border-2 border-pink-100">
              <h3 className="text-xl font-bold text-gray-900 mb-3">?? Livraison Rapide</h3>
              <p className="text-gray-600">
                Nous livrons vos commandes rapidement dans toute la region.
              </p>
            </div>
            <div className="bg-white rounded-2xl p-8 shadow-lg border-2 border-pink-100">
        ...
        <section className="px-4 sm:px-6 lg:px-8 py-20 max-w-7xl mx-auto">
          <div className="bg-gradient-to-r from-pink-600 to-rose-500 rounded-3xl p-12 sm:p-16 text-center text-white shadow-2xl">
            <h2 className="text-4xl font-bold mb-4">Pret a commencer?</h2>
            <p className="text-lg mb-8 opacity-90 max-w-2xl mx-auto">
              Explorez notre collection et passez votre premiere commande des maintenant!
            </p>
            <Link to="/products">
